# Generated by Django 4.2.7 on 2023-11-30 03:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kategori', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produks', to='AQIL.kategori')),
            ],
        ),
    ]
